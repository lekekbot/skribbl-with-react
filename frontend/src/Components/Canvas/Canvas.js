    ...
    return (
        <div className={styles.canvasBox}>
            ...
            <Row className={styles.canvasTools}>
                ...
                <Row>
                    <Col>
                        <Button onClick={() => setcolor("red")} className={styles.button} style={{ background: "red"}} ></Button>
                        <Button onClick={() => setcolor("orange")} className={styles.button} style={{ background: "orange"}} ></Button>
                        <Button onClick={() => setcolor("yellow")} className={styles.button} style={{ background: "yellow"}} ></Button>
                        <Button onClick={() => setcolor("lime")} className={styles.button} style={{ background: "lime"}} ></Button>
                        <Button onClick={() => setcolor("green")} className={styles.button} style={{ background: "green"}} ></Button>
                        <Button onClick={() => setcolor("dodgerblue")} className={styles.button} style={{ background: "dodgerblue"}} ></Button>
                        <Button onClick={() => setcolor("blue")} className={styles.button} style={{ background: "blue"}} ></Button>
                        <Button onClick={() => setcolor("pink")} className={styles.button} style={{ background: "pink"}} ></Button>
                        <Button onClick={() => setcolor("purple")} className={styles.button} style={{ background: "magenta"}} ></Button>
                        <Button onClick={() => setcolor("brown")} className={styles.button} style={{ background: "brown"}} ></Button>
                        <Button onClick={() => setcolor("black")} className={styles.button} style={{ background: "black"}} ></Button>
                        <Button onClick={() => setcolor("white")} className={styles.button} style={{ background: "white"}} ></Button>
                    </Col>
                </Row>
            </Row>
        </div>
